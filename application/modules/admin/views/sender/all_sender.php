    ...
    <div class="card box-shadow">
              <div class="row">
                <div class="col-md-10  m-t-10">
                    <form id="profile_update" method="POST" action="<?php echo base_url('admin/searchSender');?>" data-parsley-validate="" novalidate="">
                           <div class="row body">
                            <?php $searchData= $this->session->userdata('senderdata');?>
                        ...
                        <div class="col-lg-4 col-md-12">
                                ...
                                <a class="btn btn-primary btn-round color-purple" href="<?php echo base_url('admin/all_senders');?>">Reset </a>
                         </div>
                    </form>
                </div>
               ...
               <!-- <a  href="<?php echo base_url('admin/home/exportUsercsv/1/'.$searchData['user_status']);?>" class="btn btn-primary btn-round text-right m-r-30">Export CSV</a> -->
                  <a  href="<?php echo base_url('admin/home/exportUsercsv/1/'.$searchData['user_status']);?>" class="btn btn-primary btn-round text-right m-r-30">Export CSV</a>
                  <?php } else{ ?>
                    <a  href="<?php echo base_url('admin/home/exportUsercsv/1/'.$searchData);?>" class="btn btn-primary btn-round text-right m-r-30">Export CSV</a>
                    <?php } ?>
              </div>
             </div>
         </div>
...
$('.sendermgmt').addClass('active');
  
  var userListingUrl =  BASEURL+"admin/home/allsendersajaxlist/";
  $('#usersList').dataTable({
    "bPaginate": true,
    "bLengthChange": true,
    "bFilter": true,
