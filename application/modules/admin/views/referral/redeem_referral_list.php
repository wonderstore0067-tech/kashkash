                            ...
                            <table id="usersList" class="table table-bordered table-striped table-hover m-b-0 js-basic-example dataTabl ">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="heading_center"> Redeem Points</th>
                                        <th class="heading_center"> Balance Points</th>
...
$('.redeem_referrals').addClass('active');
  var userListingUrl =  BASEURL+"admin/referrals/allredeemajaxlist/";
