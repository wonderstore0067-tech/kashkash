                            ...
                            <table id="usersList" class="usersList table table-bordered table-striped table-hover m-b-0 js-basic-example dataTabl ">
                                <thead>
                                    <tr>                                       
                                     ...
                                     <!--    <th class="heading_center"> User Type</th> -->
                                        <th class="heading_center">Created On</th>
                                        <th class="heading_center">QR Code</th>
                                        <th class="heading_center">QR Code Image</th>
...
$('.qrcode').addClass('active');
  ...
  var userListingUrl =  BASEURL+"admin/home/allqrcodesajaxlist/";
