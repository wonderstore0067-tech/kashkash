            ...
            <div class="col-md-12">
                <div class="card box-shadow parents-list">                    
                             ...
                             <tbody>
                                        <tr class="bold">
                                            ...
                                            <tr class="bold">
                                                <td> Withdraw To </td>
                                                <td>
                                                   <span class="label label-info"> <b><?php echo isset($withdrawdata) ? $withdrawdata : '';?> </b></span>                   
                                                </td>
                                            </tr>
                    ...
                    <div class="text-center">
                        <a href="JavaScript:Void(0)" class="text-center btn print_button  btn-primary  color-purple deactivate_br"> <i class="fa fa-print" style="padding-right: 8px;"></i>  Print</a>
                    </div>
                </div>
            </div>
        </div>
