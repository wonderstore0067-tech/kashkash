                        ...
                        <div class="row ">
                         ...
                         <div class="row ">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="review_fee" id="review_fee" class="form-control" placeholder="Amount"  required data-parsley-required-message="Amount is required">
                                </div>
                            </div>
                        </div>
                         <div class="row ">
                            <div class="col-lg-6 col-md-12">
                                <label class="col-md-12 update_padding"><strong> Fee(%)</strong></label>  
                                <div class="form-group">
                                    <input type="text" name="charge_fee" id="charge_fee" class="form-control" placeholder="Fee"  required data-parsley-required-message="Fee is required">
                                </div>
                            </div>
                        </div>  
                         <div class="row ">
                            ...
                            <tbody>
                                <?php 
                                  ...
                                  if(!empty($transaction_fee)){ 
                                    ...
                                    <tr>
                                    <td><?php echo $i;?></td>
                                    <td><?php echo $value['Review_Fee'];?></td>
 ...
 $('.transfee').addClass('active');
  ...
  $("#trans_fee").submit(function(e){
    ...
    if ($(this).parsley().isValid())
    {
      ...
      saveDatas(formData,'admin/admin/transaction_fee_action','.alert-success');
    }else{
           return false;
        }
