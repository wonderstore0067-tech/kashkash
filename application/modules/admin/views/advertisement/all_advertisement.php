                    ...
                    <div class="body">
                        ...
                        <!-- ///////////////////// Add Advertisement ////////////////////////////-->
                           ...
                           <!--  <a class="btn statussucc53 activate_br waves-effect" href="javascript:void(0);" onclick="doc_status(53, '1', 'http://localhost/etippers/admin/advertisement/addAdvTempGet' , 'Users', 'Is_Active','Id','1');" title="Active">Add Advertisement</a> -->
                            ...
                            <a href="<?php echo base_url();?>admin/advertisement/addAdvertisements" title="Edit"  class="btn statussucc53 activate_br waves-effect">Add Advertisement</a>
                            ...
                            <table id="usersList" class="usersList table table-bordered table-striped table-hover m-b-0 js-basic-example dataTabl search_box_right">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="heading_center">Advertisement Title</th>
                                        <th class="heading_center">Advertisement SubTitle</th>
                                        <th class="heading_center">Advertisement Address</th>
                                        <th class="heading_center">Advertisement Type</th>
                                        <th class="heading_center">Advertisement Image</th>
...
<script type="text/javascript">
  $('.advertisement_mgmt').addClass('active');
  var userListingUrl =  BASEURL+"admin/advertisement/alladvertisementajaxslist";
  $('#usersList').dataTable({
    "bPaginate": true,
    "bLengthChange": true,
    "bFilter": true,
