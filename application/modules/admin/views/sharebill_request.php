                            ...
                            <table id="usersList" class="table table-bordered table-striped table-hover m-b-0 js-basic-example dataTabl ">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="heading_center">Shared From</th>
                                        <th class="heading_center">Shared To</th>
...
$('.sharebill').addClass('active');

  var userListingUrl =  BASEURL+"admin/home/sharebill_ajaxlist/";
