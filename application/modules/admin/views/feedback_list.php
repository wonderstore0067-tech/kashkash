                            ...
                            <table id="usersList" class="usersList table table-bordered table-striped table-hover m-b-0 js-basic-example dataTabl ">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="heading_center"> User Name</th>
                                        <th class="heading_center">Email</th>
                                        <th class="heading_center"> Subject</th>
                                   <!--      <th class="heading_center">Meassge</th> -->
                                      <!--   <th class="heading_center">Type</th> -->
...
$('.feedback').addClass('active');
  ...
  var userListingUrl =  BASEURL+"admin/home/allfeedbackajaxlist/";
