                            ...
                            <table id="usersList" class="table table-bordered table-striped table-hover m-b-0 js-basic-example dataTabl ">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="heading_center">Sent From</th>
                                        <th class="heading_center">Sent To</th>
...
$('.sendmoney').addClass('active');


  var userListingUrl =  BASEURL+"admin/home/send_money_ajaxlist/";
