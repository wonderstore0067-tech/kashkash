    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="cursor:default;"><img src="<?php echo base_url('assets/images/'.$logo);?>" height="30" alt=""><span class="m-l-10"></span></a>
        ...
        <li class="float-right">
            ...
            <a href="<?php echo base_url('admin/admin/logout');?>" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a>
        ...
        <li class="hidden-sm-down float-right search_margin">
            ...
            <div class="input-group ">                
                <input type="text" name="q" id="search" class="form-control  search_height" placeholder="Search...">
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="tab-content bg_yellow">
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list white">
                   ...
                   <li class="<?php echo strpos($reqactive, 'dashboard') !== false ? 'active' : '';?>"><a href="<?php echo site_url('admin/dashboard');?>"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
                    <?php } 

                    if($user_manage == 1){ 
                    ?>

                    <li class="usermgmt"><a href="javascript:void(0);" class="menu-toggle"><i class="icon-user  "></i><span>Users Management</span> </a>
                ...
                <?php } 
                 if($merchant_manage == 1){    
                    ?>
                     <li class="merchant_mgmt"><a href="javascript:void(0);" class="menu-toggle"><i class="icon-add_user_phonebook"></i><span>Merchant Management</span> </a>
                        <ul class="ml-menu">
                ...
                <?php } if($transaction == 1){ 
                    ?>
                     <li class="<?php echo strpos($reqactive, 'all_transactions') !== false ? 'active' : '';?>"><a href="<?php echo site_url('admin/all_transactions');?>" class=""><i class="fa fa-money"></i><span> Transactions</span> </a>   
                    </li> 
                    <?php } if($withdraw == 1){    ?>
                     
                     <li class="withdraw"><a href="javascript:void(0);" class="menu-toggle"><i class="icon-cashout"></i><span> Withdraw Money</span> </a>
                        <ul class="ml-menu">
                ...
                <?php } if($deposit == 1){ ?>
                    ...
                    <li class="deposit"><a href="javascript:void(0);" class="menu-toggle"><i class="icon-add_money"></i><span> Deposit Money</span> </a>
                        <ul class="ml-menu">
                           <!--  <li><a href="<?php //echo site_url('admin/home/withdraw_method');?>"><i class="fa fa-cog"></i> Withdrawal Charges</a></li> -->
                ...
                <?php } if($send_money == 1){
                 ?>
                  <li class="sendmoney"><a href="<?php echo site_url('admin/send_money');?>" class=""><i class="icon-chat_send_money"></i><span> Send Money</span> </a>     
                  </li> 
                   <?php } if($request == 1){ ?>
                    <li class="reqmoney"><a href="<?php echo site_url('admin/request_money');?>" class=""><i class="icon-payment_request"></i><span>Request Money</span> </a>   
                    </li> 
                <?php } if($sharebill_request == 1){?>
                    <li class="sharebill"><a href="<?php echo site_url('admin/sharebill_request');?>" class=""><i class="icon-payment_request"></i><span> Share Bill Request</span> </a>      
                    </li> 
                     <?php } if($pay_bill == 1){ ?>
                     <li class="paybill"><a href="<?php echo site_url('admin/paybills');?>" class=""><i class="icon-pay_bill"></i><span> Pay Bills</span> </a>      
                    </li> 
                    <?php } if($qrcode == 1){ ?>
                     <li class="qrcode"><a href="<?php echo site_url('admin/all_qrcodes');?>" class=""><i class="fa fa-qrcode"></i><span> QR Codes</span> </a>      
                    </li> 
                    <?php } 
                    if($biller == 1){ ?>
                    <li class="billmg"><a href="<?php echo site_url('admin/billers_list');?>" class=""><i class="fa fa-money"></i><span>Biller Mangement</span> </a>      
                    </li> 
                <?php }?>
                 <li class="mngprcode"><a href="<?php echo site_url('admin/promocode_list');?>" class=""><i class="fa fa-codepen"></i><span>Manage Promocode </span> </a>      
                    </li> 
                <?php if($setting == 1){ ?>
                    <li class="setings"><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-gear"></i><span>Settings</span> </a>
                    <ul class="ml-menu">
                        <li class="trms_setting"><a href="<?php echo site_url('admin/terms_setting/1');?>"> Terms & Conditions</a></li>
                         <li class="privcypolicy"><a href="<?php echo site_url('admin/privacy_policy/2');?>"> Privacy & Policy</a></li>
                         <li class="aboutus"><a href="<?php echo site_url('admin/about_us/3');?>"> About Us</a></li> 
                          <li class="transfee"><a href="<?php echo site_url('admin/transaction_fee');?>"> Transaction Fees</a></li>  
                           <li class="pt_earn"><a href="<?php echo site_url('admin/points_earn');?>">Points Earn </a></li>     
                    </ul>
                    </li>
                <?php } if($website == 1){ ?>
                   <li class="webcontent"><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-desktop"></i><span>Websites Content</span> </a>
                     <ul class="ml-menu">
                        <li class="iconsetting"><a href="<?php echo site_url('admin/logo_setting');?>"> Logo + Icon Settings</a></li>   
                    </ul>
                </li>
                <?php } if($admin_management == 1){ ?>
                  <li class="adminmgmt"><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-user"></i><span>Admin Management</span> </a>
                     <ul class="ml-menu">
