	...
	function getMessageFront(){
			...
			if(isset($message) && $message!=''){
				if($messageType=='warning'){
					return "<div class='col-md-6 m-l-25 alert alert-$messageType' id='messages_warning'><strong>$message</strong></div>";
				}else{
					return "<div class='col-md-6 m-l-25 alert alert-$messageType' id='messages'><strong>$message</strong></div>";
				}
