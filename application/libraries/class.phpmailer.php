...
class PHPMailer {
   ...
   * @var string
   */
  //public $From              = 'thesaladjar@weblink.co'; 
  public $From              = '';
  ...
  */
   ...
   * @var string
   */
  //public $Hostname          = 'smtpout.asia.secureserver.net';
   ...
   * @var string
   */
 //public $Host          = 'smtpout.asia.secureserver.net';
  public $Host          = '';
   ...
   * @var string
   */
  public $Username      = ''; //for zoneit smtp username
  ...
  */
  ...
  protected function EncodeFile($path, $encoding = 'base64') {
    ...
    if (function_exists('get_magic_quotes_runtime')) {
      ...
      $magic_quotes = 0; // Assume magic quotes are disabled
    }
	  if ($magic_quotes) {
